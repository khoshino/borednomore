...
<html>
	...
	<body>
		...
		<div data-role="page" id="privpol" data-title="Privacy Policy">
			...
			<div data-role="content">
				<p>
				Your privacy is important to us.  Accordingly, we have developed this Policy in order for you to understand how we collect, use, communicate and disclose and make use of personal information.  The following outlines our privaacy policy.
				</p>
				
				<p>
				<strong>What information do we collect?</strong><br />
				"Bored No More" collects various types of information when you create an event and your Friend's List via Facebook.
				When creating an event, we request that you enter your: name, event type, event location, and event time. 
				When joining an event, we require you to connect via Facebook.
		...
		<div data-role="page" id="tos" data-title="Terms of Service">
			...
			<div data-role="content">
				...
				<p>Bored No More may revise these terms of use for its web site at any time without notice.  By using this web site you are agreeing to be bound by the then current version of these Terms and Conditions of Use.</p>
				<h3>8. Governing Law</h3>
				<p>Any claim relating to Bored No More's web site shall be governed by the laws of the State of California without regard to its conflict of law provisions.</p>
